...
describe('Mobile Token Validation - Lottie Widget', function () {
  ...
  baselineScreenshotIt('android')('Android baseline vs actual screenshot (lottie page)', async function () {
  ...
  baselineScreenshotIt('ios')('iOS baseline vs actual screenshot (lottie page)', async function () {
