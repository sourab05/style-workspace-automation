# Style Workspace Automation - Full Documentation (Clean Confluence Edition)

This version removes repeated overview content and trims repeated per-doc boilerplate.

## Table Of Contents.

1. [01-GETTING-STARTED](#01-getting-started)
2. [02-FRAMEWORK-OVERVIEW](#02-framework-overview)
3. [03-ARCHITECTURE-DEEP-DIVE](#03-architecture-deep-dive)
4. [04-ADDING-NEW-WIDGETS](#04-adding-new-widgets)
5. [05-WEB-TESTING-GUIDE](#05-web-testing-guide)
6. [06-MOBILE-TESTING-GUIDE](#06-mobile-testing-guide)
7. [07-CONFIGURATION-REFERENCE](#07-configuration-reference)
8. [08-TROUBLESHOOTING-AND-FAQ](#08-troubleshooting-and-faq)
