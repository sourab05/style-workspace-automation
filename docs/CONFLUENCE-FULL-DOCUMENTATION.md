# Style Workspace Automation - Full Documentation (Confluence Edition)

This document is prepared for direct use in Confluence as a single master page.

## How to use in Confluence
1. Create a new Confluence page in your target space.
2. Paste this entire document.
3. Upload all flowchart PNG files as page attachments.
4. Ensure image links use attached filenames (already normalized below).
