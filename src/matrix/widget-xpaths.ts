...
export const mobileWidgetSelectors = {
  android: {
    'button-filled-primary-default': '~button1_caption',
    ...
    'panel-default-primary-default': '~panel1_header_title',
    'panel-footer-standard-standard-default': '~panel1_header_title',
    'cards-default-standard-default': '~supportedLocaleList1_item0',

    // Form Controls
    'formcontrols-standard-standard-default': '~custom_i',
    'formcontrols-standard-standard-focused': '~custom_i',
    'formcontrols-standard-standard-disabled': '~custom_i',

    // Form Wrapper
    // Use RN style inspector input as readiness sentinel (stable). ~entestkey_i is the form
    // field and often goes non-displayed after style commands, which wiped the in-memory
    // styles cache via restart+navigate and forced a full RN fetch per token.
    'form-wrapper-standard-standard-default': '~exinput_i',
    ...
    'tabs-standard-standard-default': '~tabs1_headers_0_title',
    'list-standard-standard-default': '~repeat_item_0_Text_caption',
    ...
    'toggle-standard-standard-default': '~toggle1_a',
    'toggle-standard-standard-on': '~toggle1_a',
    'toggle-standard-standard-disabled': '~toggle1_a',
    ...
    'wizard-standard-standard-default': '~wizard1_step1',
    'wizard-standard-standard-current': '~wizard1_step1',
    'wizard-standard-standard-active': '~wizard1_step1',
    'container-default-standard-default': '~page1',
    'container-outlined-standard-default': '~page1',
    'container-elevated-standard-default': '~page1',
    'tile-default-primary-default': '~label3_caption',
    'tile-filled-danger-default': '~label3_caption',
    'button-group-standard-standard-default': '~button1_caption',
    'anchor-standard-primary-default': '~anchor1_caption',
    'anchor-default-secondary-default': '~anchor2_caption',
    'webview-standard-standard-default': '//android.widget.TextView[@text="Home"]',
    'spinner-standard-standard-default': '~spinner1_l',
    'search-standard-standard-default': '~search1_i',
    'progress-bar-standard-standard-default': '~progress_bar1_progressbar',
    'progress-bar-filled-default-default': '~progress_bar1_progressbar',
    'progress-bar-filled-info-default': '~progress_bar1_progressbar',
    'progress-bar-filled-success-default': '~progress_bar1_progressbar',
    'progress-bar-filled-warning-default': '~progress_bar1_progressbar',
    'progress-bar-filled-danger-default': '~progress_bar1_progressbar',
    'progress-circle-standard-standard-default': '~progress_circle1_progresscircle',
    'progress-circle-filled-default-default': '~progress_circle1_progresscircle',
    'progress-circle-filled-info-default': '~progress_circle1_progresscircle',
    'progress-circle-filled-success-default': '~progress_circle1_progresscircle',
    'progress-circle-filled-warning-default': '~progress_circle1_progresscircle',
    'progress-circle-filled-danger-default': '~progress_circle1_progresscircle',
    'dropdown-menu-standard-standard-default': '~page1',
    'popover-standard-standard-default': '~mobile_navbar1_backbtn_icon',
    'login-standard-standard-default': 'loggedInUserForm1_submit_formAction_a',
    'calendar-standard-standard-default': '~calendar1_nextmonthicon_icon',
    'slider-standard-standard-default': '~anchor1_caption',
    'rating-standard-standard-default': '~rating1_star1_icon',
    'icon-default-2x-default': '~icon2_icon',
    'icon-default-5x-default': '~exinput_i',
    'lottie-standard-standard-default': '~page1',
    'audio-standard-standard-default': '~audio1_mute_a',
    'message-filled-error-default': '~message2_caption',
    'message-filled-success-default': '~message2_caption',
    'modal-standard-standard-default': '~dialog1_icon_caption',
    'fileupload-standard-standard-default': '~fileupload1_icon_icon',
    'currency-standard-standard-default': '~label1_caption',
    'select-standard-standard-default': '~label4_caption',
    'camera-standard-standard-default': '~camera1_button_icon_icon',
    'datetime-standard-standard-default': '~datetime1_l',
    'video-standard-standard-default': '~page1',

  },
  ios: {
    'button-filled-primary-default': '~button1_caption',
    'button-filled-primary-disabled': '~button1_caption',
    'button-filled-secondary-default': '~button1_caption',
    'button-filled-secondary-disabled': '~button1_caption',
    'button-outlined-tertiary-default': '~button1_caption',
    'button-outlined-tertiary-disabled': '~button1_caption',
    'button-text-info-default': '~button1_caption',
    'button-text-info-disabled': '~button1_caption',
    'button-elevated-standard-default': '~button1_caption',
    'button-elevated-standard-disabled': '~button1_caption',
    'accordion-standard-standard-default': '~accordion1_header0',
    'accordion-pane-standard-standard-default': '~accordion1_header0',
    'label-standard-standard-default': '~label3_caption',
    'panel-standard-standard-default': '~panel1',
    ...
    // New widgets
    'label-default-h1-default': '~label9_caption',
    'panel-default-primary-default': '~panel1_header_title',
    'panel-footer-standard-standard-default': '~panel1_header_title',
    'cards-default-standard-default': '~supportedLocaleList1_item0',
    ...
    'picture-default-circle-default': '~picture2_picture',
    'picture-thumbnail-standard-default': '~picture3_picture',
    'carousel-standard-standard-default': '~carousel1_prev_icon_icon',
    'tabbar-standard-standard-default': '~mobile_tabbar1',
    'bottomsheet-standard-standard-default': '~bottomsheet1_scorllview',
    'barcodescanner-standard-standard-default': '~barcodescanner1_button_icon_icon',
    'tabs-standard-standard-default': '~tabs1_headers_0_title',
    'list-standard-standard-default': '~repeat_item_0_Text_caption',
    'chips-filled-primary-default': '~chips1_chip0',
    ...
    'chips-elevated-standard-disabled': '~chips2_chip0',
    'chips-elevated-standard-active': '~chips2_chip0',
    'radioset-standard-standard-default': '~radioset1_caption0',
    'radioset-standard-standard-checked': '~radioset1_caption0',
    'radioset-standard-standard-disabled': '~radioset1_caption0',
    'checkbox-standard-standard-default': '~checkbox1_l',
    'checkbox-standard-standard-checked': '~checkbox1_l',
    'checkbox-standard-standard-disabled': '~checkbox1_l',
    'checkboxset-standard-standard-default': '//XCUIElementTypeStaticText[@name="checkboxset1_0"]',
    'checkboxset-standard-standard-checked': '//XCUIElementTypeStaticText[@name="checkboxset1_0"]',
    'checkboxset-standard-standard-disabled': '//XCUIElementTypeStaticText[@name="checkboxset1_0"]',
    'toggle-standard-standard-default': '~toggle1_a',
    'toggle-standard-standard-on': '~toggle1_a',
    'toggle-standard-standard-disabled': '~toggle1_a',
    'switch-standard-standard-default': '~switch1_label0',
    ...
    'anchor-standard-primary-default': '~anchor1_caption',
    'anchor-default-secondary-default': '~anchor2_caption',
    'webview-standard-standard-default': '~exinput_i',
    'spinner-standard-standard-default': '~spinner1_l',
    'search-standard-standard-default': '~search1_i',
    'progress-bar-standard-standard-default': '~progress_bar1_progressbar',
    'progress-bar-filled-default-default': '~progress_bar1_progressbar',
