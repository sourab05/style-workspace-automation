...
export const mobileWidgetSelectors = {
  android: {
    ...
    'container-default-standard-default': '~mobile_navbar1_title',
    'container-outlined-standard-default': '~mobile_navbar1_title',
    'container-elevated-standard-default': '~mobile_navbar1_title',
    ...
    'calendar-standard-standard-default': '~exinput_i',
    'slider-standard-standard-default': '~anchor1_caption',
    'rating-standard-standard-default': '~exinput_i',
    'icon-default-2x-default': '~exinput_i',
    'icon-default-5x-default': '~exinput_i',
    'lottie-standard-standard-default': '~exinput_i',
    'audio-standard-standard-default': '~exinput_i',
    ...
    'fileupload-standard-standard-default': '~exinput_i',
  ...
  ios: {
    ...
    'switch-standard-standard-selected': '~switch1_label0',
    'switch-standard-standard-disabled': '~switch1_label0',
    'wizard-standard-standard-default': '~exinput_i',
    'wizard-standard-standard-current': '~exinput_i',
    'wizard-standard-standard-active': '~exinput_i',
    'container-default-standard-default': '~mobile_navbar1_title',
    'container-outlined-standard-default': '~mobile_navbar1_title',
    'container-elevated-standard-default': '~mobile_navbar1_title',
    'tile-default-primary-default': '~exinput_i',
    'tile-filled-danger-default': '~exinput_i',
    'button-group-standard-standard-default': '~button1_caption',
    'anchor-standard-primary-default': '~anchor1_caption',
    'anchor-default-secondary-default': '~anchor2_caption',
    'webview-standard-standard-default': '~exinput_i',
    'spinner-standard-standard-default': '~exinput_i',
    'search-standard-standard-default': '~exinput_i',
    'progress-bar-standard-standard-default': '~progress_bar1_progressbar',
    'progress-bar-filled-default-default': '~progress_bar1_progressbar',
    'progress-bar-filled-info-default': '~progress_bar1_progressbar',
    'progress-bar-filled-success-default': '~progress_bar1_progressbar',
    ...
    'progress-circle-filled-warning-default': '~progress_circle1_progresscircle',
    'progress-circle-filled-danger-default': '~progress_circle1_progresscircle',
    'dropdown-menu-standard-standard-default': '~exinput_i',
    'popover-standard-standard-default': '~exinput_i',
    'login-standard-standard-default': 'loggedInUserForm1_submit_formAction_a',
    'calendar-standard-standard-default': '~exinput_i',
    'slider-standard-standard-default': '~anchor1_caption',
