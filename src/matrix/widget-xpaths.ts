...
export const mobileWidgetSelectors = {
  android: {
    ...
    'slider-standard-standard-default': '~exinput_i',
    ...
    'message-filled-error-default': '~exinput_i',
    'message-filled-success-default': '~exinput_i',
  ...
  ios: {
    ...
    // Form Controls
    'formcontrols-standard-standard-default': '~',
    'formcontrols-standard-standard-focused': '~',
    'formcontrols-standard-standard-disabled': '~exinput_i',
    ...
    'checkboxset-standard-standard-checked': '~Option 1',
    'checkboxset-standard-standard-disabled': '~Option 1',
    'toggle-standard-standard-default': '~exinput_i',
    'toggle-standard-standard-on': '~exinput_i',
    'toggle-standard-standard-disabled': '~exinput_i',
    'switch-standard-standard-default': '~switch1_label0',
    'switch-standard-standard-selected': '~switch1_label0',
    'switch-standard-standard-disabled': '~switch1_label0',
    ...
    'container-default-standard-default': '~exinput_i',
    'container-outlined-standard-default': '~exinput_i',
    'container-elevated-standard-default': '~exinput_i',
    ...
    'progress-bar-standard-standard-default': '~exinput_i',
    'progress-bar-filled-default-default': '~exinput_i',
    'progress-bar-filled-info-default': '~exinput_i',
    'progress-bar-filled-success-default': '~exinput_i',
    'progress-bar-filled-warning-default': '~exinput_i',
    'progress-bar-filled-danger-default': '~exinput_i',
    'progress-circle-standard-standard-default': '~exinput_i',
    'progress-circle-filled-default-default': '~exinput_i',
    'progress-circle-filled-info-default': '~exinput_i',
    'progress-circle-filled-success-default': '~exinput_i',
    'progress-circle-filled-warning-default': '~exinput_i',
    'progress-circle-filled-danger-default': '~exinput_i',
